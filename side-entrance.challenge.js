...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        // Paying back the flashloan using deposit and
        // withdrawing the funds after.

        const Exploit = await ethers.getContractFactory("contracts/side-entrance/Exploit.sol:Exploit", attacker);
        const exploit = await Exploit.deploy(this.pool.address);
