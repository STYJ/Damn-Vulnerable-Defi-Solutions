...
describe('[Challenge] Free Rider', function () {
    ...
    it('Exploit', async function () {
        ...
        // Maybe one day I'll get around to writing these solutions because
        // the past few challenges have been quite repetitive.

        // Use flash swaps from univ2
        // Error is on line 80 `token.safeTransferFrom(token.ownerOf(tokenId), msg.sender, tokenId);`
        // You're paying the owner of the NFT which was transferred to the seller
        // So effectively, the seller is paying themselves.
    });
