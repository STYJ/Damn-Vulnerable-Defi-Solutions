...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        // Advance 5 days
        // Flashloan, deposit into pool, collect rewards, withdraw all in the same tx

        // The reason this is possible is because of the way snapshots are tracked.
        // It is based on the assumption that a new snapshot is taken within the 5
        // day period but if you take the snapshot after 5 days, you can deposit
        // and claim your rewards in the same transaction.

        const Exploit = await ethers.getContractFactory("contracts/the-rewarder/Exploit.sol:Exploit", attacker);
        ...
        await exploit.prep(TOKENS_IN_LENDER_POOL);
    });
